...
(
  ...
  CONSTRAINT playlisttable_pkey PRIMARY KEY (uid )
)
WITH (
  OIDS=FALSE
);
...
/*
###################################################################################################
hier wird die playlist erstellt
###################################################################################################
*/
function create_html_playlist($playlist_array)
{
...
{
	echo create_html_playlist($playlist_array);
}
else
{
...
$connection = pg_connect("
				 host=".DB_SERVER_PLAYLIST." 
				 dbname=".DB_NAME_PLAYLIST."
				 user=".DB_USER_PLAYLIST."www 
				 password=".DB_PASSWORD_PLAYLIST."
			");

if( !$connection )
  die("Keine Verbindung moeglich: " . pg_last_error());
